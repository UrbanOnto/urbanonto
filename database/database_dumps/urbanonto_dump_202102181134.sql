...
--
-- Name: historical_sources; Type: TABLE; Schema: ontology_sources; Owner: postgres
--

CREATE TABLE ontology_sources.historical_sources (
    identifiers integer NOT NULL,
    titles text,
    bibliographic_data text
);
...
ALTER TABLE ontology_sources.historical_sources OWNER TO postgres;
...
--
-- Name: locations; Type: TABLE; Schema: ontology_sources; Owner: postgres
--
...
ALTER TABLE ontology_sources.locations OWNER TO postgres;
...
CREATE TABLE ontology_sources.topographic_object_function_manifestation_sources (
    topographic_object_identifiers integer,
    starts_at text,
    ends_at text,
    functions text,
    historical_source_identifiers integer
...
CREATE TABLE ontology_sources.topographic_object_mereological_link_manifestation_sources (
    ...
    starts_at text,
    ends_at text,
    whole_identifiers integer,
    part_identifiers integer,
    historical_source_identifiers integer
);
...
CREATE TABLE ontology_sources.topographic_object_provenances (
    ...
    predecessor_identifiers integer
);
...
--
-- Name: historical_sources historical_sources_pkey; Type: CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.historical_sources
    ADD CONSTRAINT historical_sources_pkey PRIMARY KEY (identifiers);
...
--
-- Name: locations locations_pkey; Type: CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.locations
    ADD CONSTRAINT locations_pkey PRIMARY KEY (identifiers);


--
-- Name: locations locations_the_geom_key; Type: CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.locations
    ADD CONSTRAINT locations_the_geom_key UNIQUE (the_geom);
...
--
-- Name: topographic_object_function_manifestation_sources topographic_object_function_m_historical_source_identifier_fkey; Type: FK CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.topographic_object_function_manifestation_sources
    ADD CONSTRAINT topographic_object_function_m_historical_source_identifier_fkey FOREIGN KEY (historical_source_identifiers) REFERENCES ontology_sources.historical_sources(identifiers) NOT VALID;
...
--
-- Name: topographic_object_location_manifestation_sources topographic_object_location_m_historical_source_identifier_fkey; Type: FK CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.topographic_object_location_manifestation_sources
    ADD CONSTRAINT topographic_object_location_m_historical_source_identifier_fkey FOREIGN KEY (historical_source_identifiers) REFERENCES ontology_sources.historical_sources(identifiers) NOT VALID;
...
--
-- Name: topographic_object_location_manifestation_sources topographic_object_location_manifesta_location_identifiers_fkey; Type: FK CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.topographic_object_location_manifestation_sources
    ADD CONSTRAINT topographic_object_location_manifesta_location_identifiers_fkey FOREIGN KEY (location_identifiers) REFERENCES ontology_sources.locations(identifiers) NOT VALID;


--
-- Name: topographic_object_mereological_link_manifestation_sources topographic_object_mereologic_historical_source_identifier_fkey; Type: FK CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.topographic_object_mereological_link_manifestation_sources
    ADD CONSTRAINT topographic_object_mereologic_historical_source_identifier_fkey FOREIGN KEY (historical_source_identifiers) REFERENCES ontology_sources.historical_sources(identifiers) NOT VALID;
...
--
-- Name: topographic_object_name_manifestation_sources topographic_object_name_manif_historical_source_identifier_fkey; Type: FK CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.topographic_object_name_manifestation_sources
    ADD CONSTRAINT topographic_object_name_manif_historical_source_identifier_fkey FOREIGN KEY (historical_source_identifiers) REFERENCES ontology.historical_sources(identifiers) NOT VALID;
...
ALTER TABLE ONLY ontology_sources.topographic_object_name_manifestation_sources
    ADD CONSTRAINT topographic_object_name_manifestation_name_link_type_names_fkey FOREIGN KEY (name_link_type_names) REFERENCES ontology_sources.name_link_type_sources(names) NOT VALID;
...
--
-- Name: topographic_object_type_manifestation_sources topographic_object_type_manif_historical_source_identifier_fkey; Type: FK CONSTRAINT; Schema: ontology_sources; Owner: postgres
--

ALTER TABLE ONLY ontology_sources.topographic_object_type_manifestation_sources
    ADD CONSTRAINT topographic_object_type_manif_historical_source_identifier_fkey FOREIGN KEY (historical_source_identifiers) REFERENCES ontology_sources.historical_sources(identifiers) NOT VALID;
