...
from ontology_initial_import.constants.excel_file_constants import *
from ontology_initial_import.constants.ontology_constants import *
from ontology_initial_import.excel_exporters.export_helpers import create_iri_for_object_in_type
from ontology_initial_import.excel_exporters.function_exporter import add_functions_to_entity
from ontology_initial_import.excel_exporters.mereology_exporter import add_wholes_to_entity, add_parts_to_entity
from ontology_initial_import.excel_exporters.reference_data_exporter import export_reference_data
from ontology_initial_import.owl_handlers.literal_creators import *
from ontology_initial_import.owl_handlers.owl_importer import add_recursively_owl_imports_to_ontology
from ontology_initial_import.owl_handlers.owl_restriction_getter import *
from ontology_initial_import.owl_handlers.register import Register
    ...
    if index == NAME_ROW_NO:
        if len(pl_row_value) > 0:
            ...
            if name_pl_literal in Register.labels_to_iris_map.keys():
                ...
                logging.warning(
                    msg='Object type with label ' + pl_row_value + ' already exists in ontology_initial_import. Is this intended?')
            else:
