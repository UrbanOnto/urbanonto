...
def add_parts_to_entity(excel_sheet_name: str, parts_string:str, entity: URIRef, ontology: Graph, created_entities_register: dict):
    part_strings = parts_string.split(',')
    for part_string in part_strings:
        part = __get_mereology(mereology_string=part_string, created_entities_register=created_entities_register, ontology=ontology)
...
def add_wholes_to_entity(excel_sheet_name: str, wholes_string:str, entity: URIRef, ontology: Graph, object_type_register: dict):
    whole_strings = wholes_string.split(',')
    for whole_string in whole_strings:
        whole = __get_mereology(mereology_string=whole_string, created_entities_register=object_type_register, ontology=ontology)
